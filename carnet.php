...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Historique complet de vos candidatures</p>
            <div class="subtitle">Suivez toutes vos lettres de motivation générées et envoyées</div>
        </div>

        <div class="navigation">
            <a href="generer-lettre.php" class="nav-btn">
        ...
        <div class="content">
            ...
            <?php else: ?>
                ...
                <div class="stats">
                    ...
                    <div class="stat-card">
                        <div class="stat-number"><?php echo count(array_filter($data, function($row) { return !empty($row['Email']); })); ?></div>
